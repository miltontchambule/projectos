...
function setModoClaro(ativo) {
    navbar.classList.toggle("modo-claro", ativo);
    logo.style.opacity = 0;
    
    setTimeout(() => {
        logo.src = ativo
        ? "/Media/blacklogo.png"
        : "/Media/Logokoffee160.png";
        logo.style.opacity = 1;
    }, 150);
}

//sempre que navbar passar por uma zona clara da pagina
...
ScrollTrigger.create({
    ...
    onEnter: () => setModoClaro(true),
    onLeave: () => setModoClaro(false),
    onEnterBack: () => setModoClaro(true),
    onLeaveBack: () => setModoClaro(false) 
});
